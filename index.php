...
<body>
     ...
     <div class="col-md-5 p-lg-5 mx-auto my-5">
       ...
       <h1 class="display-4 fw-normal text-danger">اربح مع نور </h1>
       <p class="lead fw-normal">باقي على فتح التسجيل</p>
       <p class="lead text-info">للسحب على سحب نسحةمجانيةمن برنامج</p>
     ...
     <ul class="list-group">
       ...
       <li class="list-group-item">وخامس واحد</li>
     </ul>
